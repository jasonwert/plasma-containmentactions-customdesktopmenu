...
QString CustomDesktopMenu::getDefaultMenu()
{
  ...
  defMenuConfig += "Lock\tsystem-lock-screen\tqdbus org.kde.ksmserver /ScreenSaver Lock\n";
  defMenuConfig += "Sleep\tsystem-suspend\tqdbus org.kde.Solid.PowerManagement /org/freedesktop/PowerManagement Suspend\n";
  defMenuConfig += "-\n";
  defMenuConfig += "Restart\tsystem-reboot\tqdbus org.kde.ksmserver /KSMServer logout -1 1 3\n";
  defMenuConfig += "Shut down\tsystem-shutdown\tqdbus org.kde.ksmserver /KSMServer logout -1 2 3\n";
  defMenuConfig += "[end]\n";
  defMenuConfig += "-\n";
